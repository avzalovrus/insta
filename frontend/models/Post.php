...
class Post extends \yii\db\ActiveRecord
{
    ...
    /**
     * Связь между таблицей post и таблицей user
     * У каждого поста один автор
     */
    /**
    ...
    /**
     * Лайкнут ли пост указанным пользователем
    ...
    /**
     * Принимает на вход пользователя который пожаловался
     */
    /**
    ...
    public function complain(User $user)
    {
        ...
        /**
         * Если пользователь еще не жаловался то обрабатываем жалобу
         */
